...
export default function socialMedia() {
  ...
  return (
    <div>
      ...
      <div className="social-media-div social-lap">
      ...
      <div className="social-media-div social-mob">
        {socialMediaLinks.github ? (
          <a
            href={socialMediaLinks.github}
            className="icon-button github"
          ...
          >
            <div className="greet-icons">
              <FaGithub className="greet-svg github" />
            </div>
            <span></span>
          </a>
        ) : null}
        ...
        {socialMediaLinks.linkedin ? (
          ...
          >
            <div className="greet-icons">
              <FaLinkedin className="greet-svg linked" />
            </div>
            <span></span>
          </a>
        ) : null}
